...
export const MORSE_TO_ENGLISH = Object.fromEntries(
  Object.entries(ENGLISH_TO_MORSE).map(([letter, morse]) => [morse, letter])
);

export const ENGLISH_TO_MORSE_TRANSLATE = (text) => {
...
export const MORSE_TO_ENGLISH_TRANSLATE = (text) => {
    if (typeof text !== 'string') {
        throw new Error('Input must be a string');
    }
